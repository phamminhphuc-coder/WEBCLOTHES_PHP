      ...
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Copyright@ 2024 PMPShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
                  mong muốn đem đến chất lượng tốt nhất cho khách hàng.
               </p>
               <p class="pt-1">
                  Địa chỉ: 22/9 Thủ Đức
               </p>
               <p class="pt-1">
                  Điện thoại: 0385736591(call, zalo) - Email: phuc@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Phạm Minh Phúc - Phone: 0385736591
      </div>
   </section>
</body>
