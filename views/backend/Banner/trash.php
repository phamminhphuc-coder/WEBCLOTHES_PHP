         ...
         <div class="card">
               <div class="card-header ">
                  ...
                  <div div class="col-md-6">
                     <a href="index.php?option=banner" class="btn btn-sm btn-primary">Tất cả</a>
                     <a href="index.php?option=banner&cat=trash" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Thùng rác</a>
                  </div>
